    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="newsLiuyanText">
                        <el-input type="textarea"  :readonly="ro.newsLiuyanText" v-model="ruleForm.newsLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.newsLiuyanText" label="留言内容" prop="newsLiuyanText">
