...
import huanyuan from '@/views/modules/databaseBackup/huanyuan'
    ...
    import dictionaryNewsErji from '@/views/modules/dictionaryNewsErji/list'
        import dictionaryNewsErjiAddOrUpdate from '@/views/modules/dictionaryNewsErji/add-or-update'//二级
...
const routes = [{
    ...
    ,{
        path: '/dictionaryNewsErji',
        name: '二级类型',
        component: dictionaryNewsErji
    }
    ,{
        path: '/dictionaryNewsErjiAddOrUpdate',
        name: '二级类型的新增修改页面',
        component: dictionaryNewsErjiAddOrUpdate
    }
    ,{
        path: '/dictionarySex',
        name: '性别类型',
